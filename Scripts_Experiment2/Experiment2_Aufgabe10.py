...
# Plot the data
an.plot_data(data_exp2_t1, "Experiment2-Aufgabe1", data2=data_fit, plot_fit=False, get_pdf=False, scale_x="linear", scale_y="linear", lable_x="Winkel in rad", lable_y="Force in N", slope=slope, intercept=intercept, std_err=std_err)
